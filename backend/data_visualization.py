...
#plt.ylabel('')
#plt.savefig('PDF/pie_chart_visitor_types.pdf', format='pdf')
#plt.show()
#
...
#plt.ylabel('Target')
#plt.savefig('PDF/scatter_plot_visit_count_vs_target.pdf', format='pdf')
#plt.show()
#
...
#g.savefig('PDF/cat_plot_visit_count_by_continent_and_visitor_type.pdf', format='pdf')
#plt.show()
#
...
#plt.axis('off')
#plt.savefig('PDF/treemap_visitor_types_by_country.pdf', format='pdf')
#plt.show()
#
...
#plt.ylabel('Country')
#plt.savefig('PDF/heatmap_visitor_type_by_country.pdf', format='pdf')
#plt.show()
#
...
#plt.savefig('PDF/violin_plot_visit_count_by_continent.pdf', format='pdf')
#plt.show()
#
...
#plt.savefig('PDF/swarm_plot_visit_count_by_visitor_type_and_continent.pdf', format='pdf')
#plt.show()
...
# Load the data
data_frame = pd.read_csv('BACKEND/prepared_data.csv')

# Preprocess the data
data_frame.rename(columns={'eventName (actionDetails 1)': 'eventName'}, inplace=True)
